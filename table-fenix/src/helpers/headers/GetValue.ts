 ...
 */
function GetValue<T>(headerIndex:number, related:KindProperty | "related" , entity:EntityBaseSearch<T>, enumValue?: (indexEnun: number, valueEnum: number )=>string) : string {
